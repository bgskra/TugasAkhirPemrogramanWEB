<br><br>
<html>
<body BACKGROUND="editwallpaper.png">
<?php
include 'connect.php';
if (isset($_GET['id'])) {
...
?>
<h1 align="center"  style="color:black">Update Data Pelanggan</h1>
<fieldset style="width: 50%; margin: auto;">
    <legend  style="color:black">FORMULIR EDIT DATA</legend>

    <form action="update.php" method="post"  style="color:black">
        ...
        <p>
         ...
         <p>
            ...
            <input type="radio" name="harga" value="RP.375.000" id="pickup" required /><label for="pickup">Sewa (pick Up)</label>
            ...
            <input type="radio" name="harga" value="RP.525.000" id="minibus" required /><label for="minibus">Sewa (Mini Bus)</label>
            <input type="radio" name="harga" value="RP.600.000" id="mpv" checked /><label for="mpv">Sewa (MPV)</label>
            <?php endif; ?>
        </p>
